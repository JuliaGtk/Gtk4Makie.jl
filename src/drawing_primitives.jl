...
function Base.insert!(screen::GtkScreen, scene::Scene, x::Combined)
...
function draw_atomic(screen::GtkScreen, scene::Scene, @nospecialize(x::Union{Scatter, MeshScatter}))
...
function draw_atomic(screen::GtkScreen, scene::Scene, @nospecialize(x::Lines))
    return cached_robj!(screen, scene, x) do gl_attributes
...
function draw_atomic(screen::GtkScreen, scene::Scene, @nospecialize(x::LineSegments))
    return cached_robj!(screen, scene, x) do gl_attributes
        linestyle = pop!(gl_attributes, :linestyle)
        data = Dict{Symbol, Any}(gl_attributes)
        ls = to_value(linestyle)
...
function draw_atomic(screen::GtkScreen, scene::Scene,
...
function draw_atomic(screen::GtkScreen, scene::Scene, x::Heatmap)
    return cached_robj!(screen, scene, x) do gl_attributes
...
function draw_atomic(screen::GtkScreen, scene::Scene, x::Image)
    return cached_robj!(screen, scene, x) do gl_attributes
...
function draw_atomic(screen::GtkScreen, scene::Scene, meshplot::Mesh)
...
function draw_atomic(screen::GtkScreen, scene::Scene, x::Surface)
...
function draw_atomic(screen::GtkScreen, scene::Scene, vol::Volume)
